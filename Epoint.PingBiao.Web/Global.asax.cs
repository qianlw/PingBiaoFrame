...
namespace Epoint.PingBiao.Web
{
    ...
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            Epoint.PingBiao.Crond.TaskManager.Instance.Initialize(AppDomain.CurrentDomain.BaseDirectory + System.IO.Path.Combine("Configuration", "Plan.config"));
            Epoint.PingBiao.Crond.TaskManager.Instance.Start();
            Debug.WriteLine("Epoint.PingBiao启动成功");
        }
        protected void Application_Error(object sender, EventArgs e)
        {
            ...
            Epoint.PingBiao.Common.IOHelper.WriteLog(str.ToString());
            //处理完及时清理异常
#endif
            Server.ClearError();
            //跳转至出错页面 
