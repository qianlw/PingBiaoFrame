...
using System.Linq;
using System.Text;
using Epoint.PingBiao.SQLiteService;
using Epoint.PingBiao.MSSQLService;
using Epoint.PingBiao.MySQLService;
...
namespace Epoint.PingBiao.Test
{
    class Program
    {
        static void Main(string[] args)
        {
            //if (File.Exists(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\keyword01.txt") == false)
            //{
            //    File.Create(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\keyword01.txt");
            //}
            //Dictionary<string, string> keys = new Dictionary<string, string>();
            //System.IO.StreamWriter writer = new System.IO.StreamWriter(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\keyword01.txt");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\keyword.txt", Encoding.UTF8))
            //{
            ...
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\30万中文分词词库.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            ...
            //}
            //Console.WriteLine("2");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\百度分词词库.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        string value = reader.ReadLine();
            ...
            //}
            //Console.WriteLine("3");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\四十万可用搜狗txt词库.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        string value = reader.ReadLine();
            ...
            //}
            //Console.WriteLine("4");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\dict.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            ...
            //}
            //Console.WriteLine("5");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\fingerDic.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        writer.WriteLine(reader.ReadLine());
            ...
            //}
            //Console.WriteLine("6");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\httpcws_dict.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        writer.WriteLine(reader.ReadLine());
            ...
            //}
            //Console.WriteLine("7");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\out.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        string value = reader.ReadLine();
            ...
            //}
            //Console.WriteLine("8");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\四十万汉语大词库.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        writer.WriteLine(reader.ReadLine());
            ...
            //}
            //Console.WriteLine("9");
            //using (System.IO.StreamReader reader = new System.IO.StreamReader(@"G:\workspace\Epoint.PingBiao\Epoint.PingBiao.Test\key\五笔词库.txt", Encoding.UTF8))
            //{
            //    while (reader.EndOfStream == false)
            //    {
            //        writer.WriteLine(reader.ReadLine());
           ...
           // sqlite_Test();
            ...
            //mssql
            //mssql_Test();
            //Console.WriteLine(IOHelper.RemoveHead("1111122222", "1"));
            //Console.WriteLine(IOHelper.PathParse(@"//////////Documents/Tencent Files/702295399/FileRecv", 2, true));
            //Console.WriteLine(IOHelper.PathParse(@"//////////Documents/Tencent Files/702295399/FileRecv", 1, false));
            //Console.WriteLine(IOHelper.PathParse(@"\\\\\\\\\\\Documents\Tencent Files\702295399\FileRecv", 2, true));
            //Console.WriteLine(IOHelper.PathParse(@"\\\\\\\\\\\Documents\Tencent Files\702295399\FileRecv", 1,false));
            //string s=Path.GetFullPath("//////////Documents/Tencent Files/702295399/FileRecv/test.txt");
            //string ss = "111122222";
            //string dd = ss.Remove(0, 4);
            //bool b1 = System.IO.File.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web");
            //bool b2 = System.IO.File.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web\Web.config");
            //bool b3 = System.IO.File.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web\favicon");
            //bool b4 = System.IO.File.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web\favicon123");
            //bool b5 = System.IO.Directory.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web");
            //bool b6 = System.IO.Directory.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web\");
            //bool b7 = System.IO.Directory.Exists(@"D:\vs2010Workspace\Epoint.PingBiao\Epoint.PingBiao.Web\favicon");
        ...
        #region sqlite
        static Epoint.PingBiao.SQLiteService.UserServer sqlite_user = new SQLiteService.UserServer();
        static Epoint.PingBiao.SQLiteService.RoleServer sqlite_role = new SQLiteService.RoleServer();
        static Epoint.PingBiao.SQLiteService.PowerConfigService sqlite_power = new SQLiteService.PowerConfigService();
        static void sqlite_Test() {
            ...
            //sqlite_power.SaveConfig(p, @"D:\vs2010Workspace\Epoint.PingBiao\PowerConfig.config");
        ...
        #region mysql
        static Epoint.PingBiao.MySQLService.UserServer mysql_user = new MySQLService.UserServer();
        static Epoint.PingBiao.MySQLService.RoleServer mysql_role = new MySQLService.RoleServer();
        ...
        #region mssql
        static Epoint.PingBiao.MSSQLService.UserServer mssql_user = new MSSQLService.UserServer();
        static Epoint.PingBiao.MSSQLService.RoleServer mssql_role = new MSSQLService.RoleServer();
